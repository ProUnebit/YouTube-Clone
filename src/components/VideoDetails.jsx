...
const VideoDetails = () => {
    ...
    useEffect(() => {
        // document.getElementById("app").classList.add("custom-h");
        fetchVideoDetails();
        fetchRelatedVideos();
    }, [id]);
                    ...
                    <div className="flex justify-between flex-col md:flex-row mt-4">
                        <div className="flex">
                            ...
                            <div className="flex flex-col ml-3">
                                <div className="text-white text-md font-semibold flex items-center cursor-pointer" onClick={() => alert("Work in progress...")}>
                                    {video?.author?.title}
